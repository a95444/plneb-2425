...
db_file=open('conceitos.json', "r", encoding="utf-8")
with open("conceitos.json", "r", encoding="latin-1") as db_file:
...
def pesquisar_page():
    ...
    if resultados:
        ...
        return render_template("pesquisar.html", title="Pesquisar", exact_match=exact_match)
